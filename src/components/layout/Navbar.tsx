...
export default function Navbar() {
  ...
  if (location.pathname === '/greenwood') {
    return null;
  }
...
{ path: "/labs", label: t("nav.labs") || "Labs" },
...
<span className="text-base font-bold tracking-tight text-gradient-primary">{t('physics.title')}</span>
        </Link>
